...
export type TasksQuery = { tasks: { items: Array<{ id: string, title: string, description: string, location?: string | null, status: TaskStatus, createdByUserId: string, createdAt: any, dateTime?: any | null, category?: string | null, priceOfferPence?: number | null, paymentMethod?: TaskPaymentMethod | null, contactMethod?: string | null, offers: Array<{ id: string, taskId: string, workerUserId: string, pricePence: number, message?: string | null, status: OfferStatus, createdAt: any }> }>, pageInfo: { page: number, pageSize: number, totalItems: number, totalPages: number, hasNextPage: boolean, hasPreviousPage: boolean } } };
...
export type BrowseTasksQuery = { tasks: { items: Array<{ id: string, title: string, description: string, location?: string | null, status: TaskStatus, priceOfferPence?: number | null, createdAt: any, category?: string | null }> } };
...
export type MyTasksQuery = { myTasks: Array<{ id: string, title: string, description: string, status: TaskStatus, createdAt: any }> };
