            ...
            activePostedTasks.length === 0 ? (
              <GlassCard p={6}>
                <Stack gap={3}>
                  ...
                  <Text color="muted">
                    Post a job to receive quotes from local taskers. Completed
                    or closed jobs stay in your history on the task detail page.
                  </Text>
                  <Button
                    as={NextLink}
                    href="/tasks/create"
                        ...
                        <HStack align="flex-start" gap={4} flexWrap="wrap">
                          ...
                          >
                            ...
                            <Button
                              ...
                              size="sm"
                            >
                              {offerCount > 0 ? 'Review quotes' : 'View job'}
                            </Button>
                          </Stack>
                        </HStack>
          ...
          >
            <Stack gap={4}>
              ...
              <Text fontSize="sm" opacity={0.9}>
                Open a job to compare offers, message taskers, and accept a
          ...
          <GlassCard p={5} bg="surfaceContainerLow">
            <Stack gap={4}>
              ...
              {customerBookings.length === 0 ? (
                <Text fontSize="sm" color="muted">
                  When quotes arrive, active jobs with responses appear here.
                </Text>
              ) : (
                <Stack gap={3}>
